                        ...
                        <div class="card-body">
                            ...
                            <div class="col-12 p-3 row">
                                ...
                                <div class="col-12 col-lg-6 p-2">
                                    ...
                                    <div class="col-12 pt-3">
                                        <textarea name="description_ar"  class="description_editor" >{{$labrosan->getTranslation('description','ar')}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-lg-6 p-2">
                                    ...
                                    <div class="col-12 pt-3">
                                        <textarea name="description_he" class="description_editor" >{{$labrosan->getTranslation('description','he')}}</textarea>
                                    </div>
                                </div>
